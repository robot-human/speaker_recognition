...
samps = functions.get_samples(speaker_files,speaker_ids[0],2000000)
print(len(samps))
...
# final_samples = functions.trim_signal(new_samples, sample_rate, 0.90)
# functions.samples_to_seconds(len(final_samples),sample_rate)
