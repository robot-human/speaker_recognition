...
functions.samples_to_seconds(len(signal_dict[speaker_ids[0]]['train']),8000)
functions.samples_to_seconds(len(signal_dict[speaker_ids[0]]['valid']),8000)
functions.samples_to_seconds(len(signal_dict[speaker_ids[0]]['test']),8000)
